...
function joyEnd() { if (!isJoyDragging) return; isJoyDragging = false; joyKnob.style.transition = "transform 0.2s ease-out"; joyKnob.style.transform = `translate(0px, 0px)`; joyOutput.textContent = `X: 0 | Y: 0`; }
function joyMove(e) {
